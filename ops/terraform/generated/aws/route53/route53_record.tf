resource "aws_route53_record" "tfer--Z165JNQYTZW714_3zayxegwj7su2vr6t5bhaubhqldwctce-002E-_domainkey-002E-mdzhang-002E-com-002E-_CNAME_" {
  ...
  ttl     = "1800"
  type    = "CNAME"
  zone_id = "${aws_route53_zone.tfer--Z165JNQYTZW714_mdzhang-002E-com.zone_id}"
}
...
resource "aws_route53_record" "tfer--Z165JNQYTZW714_mdzhang-002E-com-002E-_A_" {
  alias {
    evaluate_target_health = "false"
    name                   = "s3-website-us-west-1.amazonaws.com"
    zone_id                = "Z2F56UZL2M1ACD"
...
resource "aws_route53_record" "tfer--Z165JNQYTZW714_mdzhang-002E-com-002E-_MX_" {
  name    = "mdzhang.com"
...
resource "aws_route53_record" "tfer--Z165JNQYTZW714_mdzhang-002E-com-002E-_NS_" {
  name    = "mdzhang.com"
...
resource "aws_route53_record" "tfer--Z165JNQYTZW714_mdzhang-002E-com-002E-_SOA_" {
  name    = "mdzhang.com"
...
resource "aws_route53_record" "tfer--Z165JNQYTZW714_mdzhang-002E-com-002E-_TXT_" {
  name    = "mdzhang.com"
